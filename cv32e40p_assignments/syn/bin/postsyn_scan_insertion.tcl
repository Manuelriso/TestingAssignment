...
read_ddc ${GATE_PATH}/cv32e40p_top.ddc
...
# set_dft_signal -view existing_dft -type ScanEnable -port test_en_i -active_state 1
...
set_dft_signal -view existing_dft -type Constant -port scan_cg_en_i -active_state 1
...
write -hierarchy -format ddc -output "${GATE_PATH}/cv32e40p_top_scan.ddc"
write_test_protocol -output "${GATE_PATH}/cv32e40p_top_scan.spf" -test_mode Internal_scan
write_test_protocol -output "${GATE_PATH}/cv32e40p_top_scancompress.spf" -test_mode ScanCompression_mode
