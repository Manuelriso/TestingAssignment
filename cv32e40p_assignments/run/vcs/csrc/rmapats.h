...
void  rmaPropagate27_simv_daidir (UB  * pcode, vec32  * I1103, U  I991);
void  rmaPropagate28_simv_daidir (UB  * pcode, vec32  * I1103, U  I991);
...
void  rmaPropagate36_p_simv_daidir (UB  * pcode, vec32  * I1103, U  I991);
void  rmaPropagate36_simv_daidir (UB  * pcode, vec32  * I1103, U  I991);
void  rmaPropagate36_lbs_simv_daidir (UB  * pcode, scalar  val, U  I966);
void  rmaPropagate36_lps_simv_daidir (UB  * pcode, vec32  * I1480, U  I966, U  I1490);
void  rmaPropagate36_s0f_simv_daidir (UB  * pcode, vec32  * I1103);
void  rmaPropagate37_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate39_simv_daidir (UB  * pcode, vec32  * I1103, U  I991);
void  rmaPropagate40_simv_daidir (UB  * pcode, vec32  * I1103, U  I991);
void  rmaPropagate41_simv_daidir (UB  * pcode, vec32  * I1103, U  I991);
...
void  rmaPropagate55_simv_daidir (UB  * pcode, vec32  * I1103, U  I991);
